...
export const getStudentEmailTemplate = (type, student, coachingName = 'Adamjee Coaching') => {
  ...
  if (type === 'STUDENT_CREATED') {
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2 style="margin: 0; font-size: 28px;">🎓 ${coachingName}</h2>
          ...
          <div class="content">
            ...
            <p>We are delighted to inform you that <strong>${student.firstName} ${student.lastName}</strong> has been successfully enrolled in ${coachingName}.</p>
            ...
            <div style="${detailsStyles}">
              ...
              <table style="width: 100%; font-size: 14px;">
                <tr>
                  ...
                  <td style="padding: 8px 0;">${student.studentProfile?.className || 'N/A'}</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; font-weight: bold;">Section:</td>
                  <td style="padding: 8px 0;">${student.studentProfile?.sectionName || 'N/A'}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0;">${student.studentProfile?.academicYearName || 'N/A'}</td>
                </tr>
              </table>
            </div>
            ...
            ${student.password ? `
            <div style="${detailsStyles}">
              <h4 style="margin-top: 0; color: #667eea;">Login Credentials</h4>
              <p style="margin: 0; font-size: 14px; margin-bottom: 8px;">You can log in to the student portal using these credentials:</p>
              <table style="width: 100%; font-size: 14px; background: #f8f9fa; padding: 10px; border-radius: 4px;">
                <tr>
                  <td style="padding: 4px 0; font-weight: bold; width: 40%;">Email:</td>
                  <td style="padding: 4px 0;">${student.email}</td>
                </tr>
                <tr>
                  <td style="padding: 4px 0; font-weight: bold;">Password:</td>
                  <td style="padding: 4px 0;"><code>${student.password}</code></td>
                </tr>
              </table>
              <p style="margin: 10px 0 0 0; font-size: 12px; color: #e74c3c;"><em>Please change your password after logging in for the first time.</em></p>
            </div>
            ` : ''}
            ...
            <p style="margin: 20px 0 0 0;">Best regards,<br><strong>${coachingName} Administration</strong></p>
          </div>
          
          <div class="footer">
            <p style="margin: 0;">This is an automated email. Please do not reply to this message.</p>
            <p style="margin: 5px 0 0 0;">&copy; ${new Date().getFullYear()} ${coachingName}. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="margin: 20px 0; color: #666; font-size: 14px;">If you believe this update was made in error, please contact the coaching administration immediately.</p>
      ...
      <body>
        <div class="container">
          <div class="header" style="background: linear-gradient(135deg, #d63031 0%, #e17055 100%);">
            <h2 style="margin: 0; font-size: 28px;">⚠️ ${coachingName}</h2>
          ...
          <div class="content">
            ...
            <ul style="margin: 15px 0; padding-left: 20px;">
              <li>The student will not have access to the coaching system</li>
              <li>Records will be archived for future reference</li>
              <li>To reactivate, please contact coaching administration</li>
            </ul>
            ...
            <p style="margin: 20px 0; color: #666; font-size: 14px;">If you wish to reactivate this account, please contact the coaching administration office.</p>
      ...
      <body style="${baseStyles}">
        <div style="${containerStyles}">
          <div style="${headerStyles}">
            ...
            <p style="margin: 10px 0 0 0; opacity: 0.9;">${coachingName}</p>
          </div>
          ...
          <div style="${contentStyles}">
            ...
            <div style="background: #d1ecf1; padding: 15px; border-radius: 4px; margin: 20px 0; border-left: 4px solid #17a2b8;">
              ...
              <ul style="margin: 10px 0; padding-left: 20px; color: #0c5460;">
                ...
                <li>Payment can be made at the coaching office or online</li>
            ...
            <p style="margin: 10px 0 0 0;">Best regards,<br><strong>${coachingName} Accounts Department</strong></p>
          </div>
  ...
  if (type === 'exam_scheduled') {
    const { studentName, examTitle, examType, examDate, subjectNames, className, coachingName } = student;
    return `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="margin: 20px 0; color: #666; font-size: 14px;">Best of luck for your examination! If you have any questions, please contact your class teacher or coaching administration.</p>
