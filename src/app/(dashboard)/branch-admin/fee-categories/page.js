...
export default function FeeCategoriesPage() {
    ...
    const handleEdit = (category) => {
        ...
        if (category.branchId) {
            ...
            toast.error('Cannot edit coaching-wide categories');
        }
    };
    ...
    const handleDeleteClick = (category) => {
        if (!category.branchId) {
            toast.error('Cannot delete coaching-wide categories');
            return;
        }
    ...
    // Separate categories into branch and coaching-wide
    const branchCategories = categories.filter(c => c.branchId);
    const coachingWideCategories = categories.filter(c => !c.branchId);
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white p-4 rounded-lg border">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            <p className="text-sm text-gray-600">Coaching-wide</p>
                            <p className="text-2xl font-bold text-gray-900">{coachingWideCategories.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white p-4 rounded-lg border">
                                    ...
                                    <TableRow key={category._id}>
                                        ...
                                        <TableCell>
                                            {category.branchId ? (
                                                ...
                                                <span className="text-purple-600 font-medium text-sm">Coaching-wide</span>
                                            )}
                                        </TableCell>
                                        <TableCell>
                                            {category.isActive ? (
