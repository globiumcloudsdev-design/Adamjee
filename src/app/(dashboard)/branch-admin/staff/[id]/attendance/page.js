...
export default function BranchAdminStaffAttendanceDetailPage() {
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Detailed log of staff check-ins and attendance status.</p>
            </div>
